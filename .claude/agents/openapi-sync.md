...
If the verdict is OUT OF SYNC, call mcp__github__create_issue with:
  title: "OpenAPI spec drift: <short summary>"
  body: the full discrepancy table
  labels: ["documentation"]
Only file one issue per run, even if multiple discrepancies are found.
